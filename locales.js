const locales = {
  en: {
    ...
    cleanedLocal: 'Cleaned local database',
    cleanedLocalWithCount: 'Cleaned local database ({count} files)',
  ...
  'zh-CN': {
    ...
    cleanedLocal: '已清理本地数据库',
    cleanedLocalWithCount: '已清理本地数据库（{count} 个文件）',
  ...
  'zh-TW': {
    ...
    cleanedLocal: '已清理本地資料庫',
    cleanedLocalWithCount: '已清理本地資料庫（{count} 個檔案）',
    cleaningDatabase: '正在清理資料庫...',
  ...
  ja: {
    ...
    cleanedLocal: 'ローカルデータベースをクリーンアップしました',
    cleanedLocalWithCount: 'ローカルデータベースをクリーンアップしました（{count} ファイル）',
